...
\begin{frame}
	...
	\begin{columns}[onlywidth,T]
	    ...
	    \begin{column}{0.5\textwidth}
%	    	\vspace{1em}
%	    A workflow with 1 shepherd (master), 11 jobs scripts (for multiple, concurrent execution, incl. dependency handling) was coded by one student:\vspace{-5em}
%	    \begin{tikzpicture}
%	    	\begin{axis}[,
%	    		xbar,
%	    		width=\textwidth,
...
%	    		nodes near coords,
%	    		]
%	    		\addplot coordinates { (4400,Bash) };
%	    		\addplot coordinates { (240,Perl) };
%	    		\addplot coordinates { (57,Python) };
%	    		%\legend{Topics, Posts}
%	    	\end{axis}
%	    \end{tikzpicture}
%	    \begin{itemize}[<+->]
