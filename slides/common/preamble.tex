...
\usepackage{subfig}
\usepackage{tikz}
\usetikzlibrary{arrows,shapes,backgrounds,positioning,shadows,decorations,trees,decorations.pathreplacing, graphs}
...
\title[<++course.shorttitle++>]{<++course.tittle++>An Introduction to HPC-conformant Scientific Workflows with \Snakemake} 

\subtitle{<++course.subtitle++> - <++course.edition++>} 
